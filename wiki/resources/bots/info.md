...
> __Beschreibung:__ Unofficial documentation for Undocumented Discord APIs. Also contains an outline of Discord's infrastructure.  <br/>
__Link:__ [Unofficial Discord API Docs](https://luna.gitlab.io/discord-unofficial-docs/)

## **Largest Discord Bots**
> __Beschreibung:__ An easy-to-read list of the top 25 Discord bots by server count.   <br/>
...
> __Beschreibung:__ A haste link with the 600 biggest bots on Discord, including growth stats.  <br/>
...
> __Beschreibung:__ A list that contains all the bots that were made officially by Discord.   <br/>
...
## **List of Libraries**
> __Beschreibung:__ List of all Discord API libraries and their features.   <br/>
__Link:__ [List Of Libraries](https://libs.advaith.io/)   <br/>
__Credit:__ @190916650143318016

## **Discord API Libs**
> __Beschreibung:__ A list of all the Discord API libraries.  <br/>
...
> __Beschreibung:__ A giant feature comparison for what various discord API libraries do both over REST and WS.   <br/>
...
> __Beschreibung:__ A centralized list of Discord bot lists.   <br/>
__Link:__ [Bots Lists List](https://botblock.org/lists) 

## **DStat**
> __Beschreibung:__ Get statistics about your Discord bot.   <br/>
